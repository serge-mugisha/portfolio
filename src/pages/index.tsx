  ...
  const hero = (
    <div className="box flex flex-row items-center min-h-90 bg-center bg-fixed bg-contain bg-[url('/static/hero-bg.png')]">
      <div className="basis-2/5">
        ...
        <h2 className="h4">I'm Serge Mugisha <br /> Full-stack Software developer and UI designer</h2>
        <p className="pb-3 max-w-md">
          A Full-stack Software developer, and User Interface (UI) Designer
    ...
    <>
      ...
      <div className="hidden md:block">
        <main className="pb-10">
          ...
          <div className="py-8">
            {hero}
            <h2 id="work" className="box h2 mb-5">
              Recent work
            </h2>
            <ProjectSection
              bg="purple"
              ...
              title="iVerify - Trail of Bits."
              subtitle="Mobile Threat Hunting Platform"
              description={[
                "Full-stack developer leading front-end & server-side development",
                "Focus on Identity Access and Event Management (SCIM, SSO, MDM, Conditional Access, Webhooks)",
              ]}
              skills={["Ktor", "Java Kotlin", "Stripe", "React.js", "Cypress", "Datadog", "PostgreSQL", "SendGrid", "Azure & Okta AD", "Figma", "AWS"]}
              href="https://iverify.io/"
            />
            <ProjectSection
              bg="green"
              reverse={true}
              ...
              description={[
                ...
                "Fast-paced environment focused on rapid experimentation and discovery",
              ]}
              skills={[
                "Next.js",
                "Fast API",
